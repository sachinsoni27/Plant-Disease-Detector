...
import { Sprout, Mail, Lock, User, UserPlus, AlertCircle, ArrowLeft } from 'lucide-react';
      ...
      >
        <div className="p-8 lg:p-12">
          ...
          <div className="flex flex-col items-center mb-10">
            ...
            <h1 className="text-3xl font-bold text-slate-900 dark:text-white transition-colors duration-500">{t('joinPlantAi')}</h1>
            <p className="text-slate-500 dark:text-slate-400 mt-2 transition-colors duration-500">{t('startMonitoring')}</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-sm font-semibold text-slate-700 dark:text-slate-300 ml-1 transition-colors duration-500">{t('fullName')}</label>
          ...
          <p className="text-center mt-8 text-slate-500 dark:text-slate-400 transition-colors duration-500">
            {t('alreadyAccount')}{' '}
            <Link to="/login" className="text-emerald-600 dark:text-emerald-400 font-bold hover:underline">{t('login')}</Link>
          </p>
        </div>
      </motion.div>
    </div>
